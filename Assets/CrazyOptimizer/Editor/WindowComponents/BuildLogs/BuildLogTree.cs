...
namespace CrazyOptimizer.Editor.WindowComponents.BuildLogs
{
    class BuildLogTree : TreeViewWithTreeModel<BuildLogTreeItem>
    {
        ...
        void SortIfNeeded(TreeViewItem root, IList<TreeViewItem> rows)
        {
            ...
            var items = rootItem.children.Cast<CrazyGames.TreeLib.TreeViewItem<BuildLogTreeItem>>().OrderBy(i => i.data.size);
        ...
        {
            var item = (CrazyGames.TreeLib.TreeViewItem<BuildLogTreeItem>)args.item;
        ...
        private void CellGUI(Rect cellRect, CrazyGames.TreeLib.TreeViewItem<BuildLogTreeItem> item, int column, ref RowGUIArgs args)
        {
