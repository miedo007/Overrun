// Upgrade NOTE: upgraded instancing buffer 'sprite_flash' to new syntax.
...
Shader "sprite_flash"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			UNITY_INSTANCING_BUFFER_START(sprite_flash)
				UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
#define _MainTex_ST_arr sprite_flash
				UNITY_DEFINE_INSTANCED_PROP(float, _Flash)
#define _Flash_arr sprite_flash
			UNITY_INSTANCING_BUFFER_END(sprite_flash)
...
/*ASEBEGIN
Version=19002
2046;106;1778.667;1265;889.3334;630.5;1;True;False
...
ASEEND*/
//CHKSM=EF27E9B197AB8EB0FCB731CFFBFF6E6EF13F15BA