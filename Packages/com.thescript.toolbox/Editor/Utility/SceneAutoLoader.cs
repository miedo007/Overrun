...
namespace Mtl.Toolbox
{
    ...
    {
        private const string LoadMasterSceneMenu = "File/Scene Autoload/Load Master On Play";
        ...
        [MenuItem(LoadMasterSceneMenu, true)]
        private static bool ShowLoadMasterOnPlay()
        {
            Menu.SetChecked(LoadMasterSceneMenu, LoadMasterOnPlay);
            return true;
        }

        [MenuItem(LoadMasterSceneMenu)]
        ...
        private static readonly string EditorPrefLoadMasterOnPlay = Application.productName + ".SceneAutoLoader.LoadMasterOnPlay";
        private static readonly string EditorPrefMasterScene = Application.productName + ".SceneAutoLoader.MasterScene";
        private static readonly string EditorPrefPreviousScene = Application.productName + ".SceneAutoLoader.PreviousScene";
